...
class IddsApi:
    ...
    def __call__(self, *args, **kwargs):
        return Client.call_idds_command(self.name, args, kwargs, self.dumper, self.verbose, self.compress, self.manager, self.loader)
...
class IddsApiInteface:
    ...
    def __getattr__(self, item):
        return IddsApi(item, self.dumper, self.verbose, self.idds_host, self.compress, self.manager, self.loader)
...
def get_api(dumper=None, verbose=False, idds_host=None, compress=True, manager=False, loader=None, json_outputs=False):
