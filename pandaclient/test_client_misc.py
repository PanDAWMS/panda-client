import argparse
from pandaclient.Client import set_user_secret, set_user_secret_new, get_user_secrets, get_user_secrets_new, get_events_status, get_events_status_new
...
events_status_ret_new = get_events_status([{"task_id": 4004040, "job_id": 4674379348}])
...
print("get_events_status returned: {0}".format(events_status_ret_new))